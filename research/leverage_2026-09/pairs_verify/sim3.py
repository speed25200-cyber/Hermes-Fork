...
@njit(cache=True)
def sim3(O, H, L, C, MH, ML, FR, DAY, i0, i1, nd, PA, PB, BE, Z, SA, SB, NEWM, WL, WS, mmr, imr,
         zin, zout, zstop, maxhold, lev, sleeve, fee, feem, rslip, maker, use_w, rec, tick, liqmode):
    K = PA.shape[0]
    nsym = O.shape[0]
