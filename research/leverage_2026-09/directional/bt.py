...
FEE_M = 0.0002     # perp maker (take-profit limit orders)
SLIP = 0.0001      # 1 bp market-order slippage BTC/ETH
STOP_SLIP = 0.0002 # stop-market base slippage 2 bp
STOP_IMPACT = 0.10 # + 10% of the bar's penetration beyond the stop
...
def main(conservative=True, tag='cons'):
    ...
    res.to_csv(f'{OUT}/grid_results_{tag}.csv', index=False)
    return res
