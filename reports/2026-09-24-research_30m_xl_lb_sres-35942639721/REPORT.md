...
*Généré le 2026-09-24T02:32:42+00:00 · configuration `ae1152c585bf` · 4016 s de calcul.*
...
| Porte | Valeur | Seuil | |
|---|---:|---:|:-:|
| Sharpe dégonflé (DSR) — probabilité que le vrai Sharpe > le meilleur hasard parmi les essais | 0.421 | ≥ 0.95 | ❌ |
...
- **Deflated Sharpe Ratio** (42 essais effectifs comptés) : 0.421.
...
- Sharpe 1.18, CAGR 15.2 %, drawdown max -13.7 %, 8 changements ;
- par année : 2023 : 0.6 % ; 2024 : 9.2 % ; 2025 : 56.1 % ; 2026 : -9.7 % ;
