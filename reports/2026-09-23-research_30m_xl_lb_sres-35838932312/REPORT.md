...
*Généré le 2026-09-23T09:54:00+00:00 · configuration `171db5ca8eca` · 3975 s de calcul.*
...
| Porte | Valeur | Seuil | |
|---|---:|---:|:-:|
| Sharpe dégonflé (DSR) — probabilité que le vrai Sharpe > le meilleur hasard parmi les essais | 0.338 | ≥ 0.95 | ❌ |
...
- **Deflated Sharpe Ratio** (29 essais effectifs comptés) : 0.338.
...
- **Stress** : coûts ×2 → Sharpe 0.20 ; une barre de latence → Sharpe 0.56.
